...
**Status:** iterations 01–10 pass. See the [implementation plan](auction-implementation.md) and [iteration 10 record](auction-iterations/10-auction-public-browsing.md).
