...
- Create, update, and eligible hard-delete own PostgreSQL transaction scope. Delete locks the source, checks ProductListing/raw/application blockers, explicitly removes grants/configuration, and commits physical removal; enabled crawler ingestion is not a blocker.
